...
from amplitude.consumer import Consumer, MAX_MSG_SIZE
from amplitude.request import APIError
...
class TestConsumer(unittest.TestCase):
    ...
    def test_flush_interval(self):
        ...
        with mock.patch('amplitude.consumer.post') as mock_post:
            consumer.start()
            for i in range(0, 3):
                track = {
                    'event_type': 'python event %d' % i,
                    'user_id': 'userId'
                }
                q.put(track)
    ...
    def _test_request_retry(self, consumer,
        ...
        with mock.patch('amplitude.consumer.post',
    ...
    def test_max_batch_size(self):
        ...
        with mock.patch('amplitude.request._session.post',
